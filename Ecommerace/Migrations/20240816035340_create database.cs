        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Orders_ShippingMethods_ShippingMethodsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CouponExpiration = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Skus_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                name: "AttributeOptionSku",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AttributeOptionId = table.Column<int>(type: "int", nullable: false),
                    SkusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AttributeOptionSku", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AttributeOptionSku_AttributesOptions_AttributeOptionId",
                        column: x => x.AttributeOptionId,
                        principalTable: "AttributesOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttributeOptionSku_Skus_SkusId",
                        column: x => x.SkusId,
                        principalTable: "Skus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItem_AspNetUsers_StoreId",
                        column: x => x.StoreId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SkuMedia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SkuMedia_Skus_SkuID",
                        column: x => x.SkuID,
                        principalTable: "Skus",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttributeOptionSku_AttributeOptionId",
                table: "AttributeOptionSku",
                column: "AttributeOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_AttributeOptionSku_SkusId",
                table: "AttributeOptionSku",
                column: "SkusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SkuMedia_SkuID",
                table: "SkuMedia",
                column: "SkuID");

            migrationBuilder.CreateIndex(
                name: "IX_Skus_ProductsId",
                table: "Skus",
                column: "ProductsId");
